  ...
  return (
    <main className="max-w-3xl mx-auto py-30 px-4 text-base leading-relaxed text-gray-800">
      <div className="container">
        ...
        <p className="mb-4">
          Ласкаво просимо до FlowerLab! Ці умови використання
          (&quot;Умови&quot;) регулюють ваше використання нашого вебсайту та
          послуг. Продовжуючи користуватися нашим сайтом, ви погоджуєтеся з цими
          Умовами.
        </p>
